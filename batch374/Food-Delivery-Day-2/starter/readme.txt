>> Let's do a quick refresher on what we covered on Thursday.
>> Let's talk through the different user stories that we implemented (and review some that we didn't to get us at a baseline)

USER STORIES
----------------------------------------------------------------------------------------

1) Users can list all meals to view what is available at the restaurant
2) Users can add new meals to increase variety of meals at the restaurant
3) [Users] can [list all customers] to see [who orders can be sent to in the restaurant]
4) Users can add a new customer to increase list of people available for meal orders

>> Let's review the code base we are at currently
...
>> Whiteboard what should be in a employee class
...
5) Employees can login to to be directed to an appropriate menu
...
>> Whiteboard what an order should consist of, specifically designate what classes are being referred to

Then, make sure that the following **user stories** are implemented in your program:

- As an employee, I can log in [x]
- As a manager, I can add a meal [x]
- As a manager, I can view all the meals [x]
- As a manager, I can add a customer [x]
- As a manager, I can view all the customers [x]
